...
public class ToggleRaffle implements IClientCommand {
	...
	public void execute(MinecraftServer arg0, ICommandSender arg1, String[] arg2) throws CommandException {
		...
		if (Toggled == true) {
			Toggled = false;
			telluser.appendText("Raffle notifications enabled");
		}
		else if (Toggled == false) {
			Toggled = true;
			telluser.appendText("Raffle notifications disabled");
